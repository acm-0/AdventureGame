...
def UpdateLocationImage():
    ...
    img = Image.open(imgfile).resize((400,400))
    photo_img = ImageTk.PhotoImage(img)
...
#########                                                                           #########
frame = tk.Frame(root,height=800,width=900)
frame.pack()
...
location_description_label.place(x=0,y=0,width=500,height=25)
...
items_here_label.place(x=0,y=250,width=500,height=25)
...
items_here_listbox.place(x=0,y=275,width=500,height=200)
...
inventory_label.place(x=0,y=475,width=500,height=25)
...
possible_commands_label.place(x=0,y=740,width=500,height=30)
...
subframe = tk.Frame(frame,height=400,width=400,bg="white")
subframe.place(x=500,y=400,height=400,width=400)
...
action_result_label.place(x=0,y=0,width=400,height=25)

# The Action Result textbox (the lower middle of the GUI)
action_result_textbox = tk.Text(subframe, wrap="word",bd=3,relief="solid")
...
quit_button.place(x=25,y=370,width=50,height=30)
...
clear_button.place(x=125,y=370,width=50,height=30)
...
help_button.place(x=225,y=370,width=50,height=30)

img2 = Image.open("images/OKButton.png").resize((75,25))
photo_img2 = ImageTk.PhotoImage(img2)
ok_button = tk.Button(subframe,image=photo_img2)
ok_button.place(x=325,y=370,width=50,height=30)
